...
{
	if (region.am.T === region.av.T)
	{
		return 'on line ' + region.am.T;
	}
	return 'on lines ' + region.am.T + ' through ' + region.av.T;
}
...
var $author$project$Worker$GotInput = $elm$core$Basics$identity;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Worker$input = _Platform_incomingPort('input', $elm$json$Json$Decode$string);
var $author$project$Worker$subscriptions = function (_v0) {
	return $author$project$Worker$input($elm$core$Basics$identity);
};
							...
							$elm$json$Json$Encode$object(
								_List_fromArray(
									[
										_Utils_Tuple2(
										'moduleName',
										$stil4m$elm_syntax$Elm$Syntax$ModuleName$encode(qualifiedNameRef.ac)),
										_Utils_Tuple2(
										'name',
										$elm$json$Json$Encode$string(qualifiedNameRef.bu))
									]))),
							_Utils_Tuple2(
							'patterns',
							A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$encodeFunction = function (_v5) {
	var documentation = _v5.z;
	var signature = _v5.F;
	var declaration = _v5.bg;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$encodeFunctionDeclaration = function (_v4) {
	var name = _v4.bu;
	var _arguments = _v4.y;
	var expression = _v4.u;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$encodeLetBlock = function (_v2) {
	var declarations = _v2.bh;
	var expression = _v2.u;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'direction',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $stil4m$elm_syntax$Elm$Syntax$Infix$encodeDirection, inf.bi)),
				_Utils_Tuple2(
				'precedence',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $elm$json$Json$Encode$int, inf.by)),
				_Utils_Tuple2(
				'operator',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $elm$json$Json$Encode$string, inf.aL)),
				_Utils_Tuple2(
				'function',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $elm$json$Json$Encode$string, inf.bm))
			]));
};
var $stil4m$elm_syntax$Elm$Syntax$Type$encodeValueConstructor = function (_v0) {
	var name = _v0.bu;
	var _arguments = _v0.y;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $stil4m$elm_syntax$Elm$Syntax$Type$encode = function (_v0) {
	var documentation = _v0.z;
	var name = _v0.bu;
	var generics = _v0.aa;
	var constructors = _v0.be;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$encode = function (_v0) {
	var moduleName = _v0.ac;
	var moduleAlias = _v0.ab;
	var exposingList = _v0._;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'moduleName',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $stil4m$elm_syntax$Elm$Syntax$ModuleName$encode, moduleData.ac)),
				_Utils_Tuple2(
				'exposingList',
				A2($stil4m$elm_syntax$Elm$Syntax$Node$encode, $stil4m$elm_syntax$Elm$Syntax$Exposing$encode, moduleData._))
			]));
};
...
var $stil4m$elm_syntax$Elm$Syntax$File$encode = function (_v0) {
	var moduleDefinition = _v0.bt;
	var imports = _v0.bp;
	var declarations = _v0.bh;
	var comments = _v0.b;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
...
var $author$project$Worker$onFailure = _Platform_outgoingPort('onFailure', $elm$json$Json$Encode$string);
var $author$project$Worker$onSuccess = _Platform_outgoingPort('onSuccess', $elm$core$Basics$identity);
...
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {bu: name, l: typeAnnotation};
	});
		...
		while (true) {
			...
			if (A2($elm$core$String$any, isGood, actualChar)) {
				...
				if ($stil4m$elm_syntax$ParserFast$charStringIsUtf16HighSurrogate(actualChar) && A2(
					...
					return {at: col, f: indent, d: offset, aX: row, c: src};
				}
			}
		}
	});
var $stil4m$elm_syntax$ParserFast$anyCharFollowedByWhileMap = F2(
	function (consumedStringToRes, afterFirstIsOkay) {
		return function (s) {
			var firstOffset = A2($stil4m$elm_syntax$ParserFast$charOrEnd, s.d, s.c);
			if (_Utils_eq(firstOffset, -1)) {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingAnyChar, s.aX, s.at));
			} else {
				var s1 = _Utils_eq(firstOffset, -2) ? A6($stil4m$elm_syntax$ParserFast$skipWhileHelp, afterFirstIsOkay, s.d + 1, s.aX + 1, 1, s.c, s.f) : A6($stil4m$elm_syntax$ParserFast$skipWhileHelp, afterFirstIsOkay, firstOffset, s.aX, s.at + 1, s.c, s.f);
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					consumedStringToRes(
						A3($elm$core$String$slice, s.d, s1.d, s.c)),
					s1);
			}
		};
	});
...
var $stil4m$elm_syntax$ParserFast$symbol = F2(
	function (str, res) {
		...
		return function (s) {
			var newOffset = s.d + strLength;
			return _Utils_eq(
				A3($elm$core$String$slice, s.d, newOffset, s.c),
				str + '') ? A2(
				$stil4m$elm_syntax$ParserFast$Good,
				res,
				{at: s.at + strLength, f: s.f, d: newOffset, aX: s.aX, c: s.c}) : A2(
				$stil4m$elm_syntax$ParserFast$Bad,
				false,
				A3($stil4m$elm_syntax$ParserFast$ExpectingSymbol, s.aX, s.at, str));
		};
	});
...
var $stil4m$elm_syntax$ParserFast$while = function (isGood) {
	return function (s0) {
		var s1 = A6($stil4m$elm_syntax$ParserFast$skipWhileHelp, isGood, s0.d, s0.aX, s0.at, s0.c, s0.f);
		return A2(
			$stil4m$elm_syntax$ParserFast$Good,
...
var $stil4m$elm_syntax$ParserFast$whileWithoutLinebreakAnd2PartUtf16ValidateMapWithRangeBacktrackableFollowedBySymbol = F4(
	function (whileRangeAndContentToRes, whileCharIsOkay, whileResultIsOkay, mandatoryFinalSymbol) {
		...
		return function (s0) {
			var s1Offset = A3($stil4m$elm_syntax$ParserFast$skipWhileWithoutLinebreakAnd2PartUtf16Help, whileCharIsOkay, s0.d, s0.c);
			var whileContent = A3($elm$core$String$slice, s0.d, s1Offset, s0.c);
			if (_Utils_eq(
				A3($elm$core$String$slice, s1Offset, s1Offset + mandatoryFinalSymbolLength, s0.c),
				mandatoryFinalSymbol + '') && whileResultIsOkay(whileContent)) {
				var s1Column = s0.at + (s1Offset - s0.d);
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					A2(
						whileRangeAndContentToRes,
						{
							av: {Y: s1Column, aX: s0.aX},
							am: {Y: s0.at, aX: s0.aX}
						},
						whileContent),
					{at: s1Column + mandatoryFinalSymbolLength, f: s0.f, d: s1Offset + mandatoryFinalSymbolLength, aX: s0.aX, c: s0.c});
			} else {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingStringSatisfyingPredicate, s0.aX, s0.at + 1));
			}
		};
	});
var $stil4m$elm_syntax$Elm$Parser$Expression$allowedPrefixOperatorFollowedByClosingParensOneOf = A4(
	...
	F2(
		function (operatorRange, operator) {
			return {
				b: $stil4m$elm_syntax$Rope$empty,
				a: A2(
					$stil4m$elm_syntax$Elm$Syntax$Node$Node,
					{
						av: {Y: operatorRange.av.Y + 1, aX: operatorRange.av.aX},
						am: {Y: operatorRange.am.Y - 1, aX: operatorRange.am.aX}
					},
...
var $stil4m$elm_syntax$Elm$Parser$Expression$applyExtensionRight = F2(
	function (_v0, leftNode) {
		...
		var rightExpressionNode = operation.u;
		var rightExpressionRange = rightExpressionNode.a;
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			{av: rightExpressionRange.av, am: leftRange.am},
			A4($stil4m$elm_syntax$Elm$Syntax$Expression$OperatorApplication, operation.G, operation.bi, leftNode, rightExpressionNode));
	});
...
var $stil4m$elm_syntax$ParserFast$anyChar = function (s) {
	var newOffset = A2($stil4m$elm_syntax$ParserFast$charOrEnd, s.d, s.c);
	if (_Utils_eq(newOffset, -1)) {
		...
		if (_Utils_eq(newOffset, -2)) {
			return A2(
				$stil4m$elm_syntax$ParserFast$Good,
				'\n',
				{at: 1, f: s.f, d: s.d + 1, aX: s.aX + 1, c: s.c});
		} else {
			...
			if (!_v0.b) {
				...
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					c,
					{at: s.at + 1, f: s.f, d: newOffset, aX: s.aX, c: s.c});
			}
		}
	}
};
	...
	function (str, _v0) {
		...
		return function (s0) {
			...
			if (!_v1.$) {
				var res = _v1.a;
				var s1 = _v1.b;
				var newOffset = s1.d + strLength;
				return _Utils_eq(
					A3($elm$core$String$slice, s1.d, newOffset, s1.c),
					str + '') ? A2(
					$stil4m$elm_syntax$ParserFast$Good,
					res,
					{at: s1.at + strLength, f: s1.f, d: newOffset, aX: s1.aX, c: s1.c}) : A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					true,
					A3($stil4m$elm_syntax$ParserFast$ExpectingSymbol, s1.aX, s1.at, str));
			} else {
				var bad = _v1;
				return bad;
			}
	...
	return A3(
		...
		F2(
			function (c, soFar) {
				return {
					Z: soFar.Z + 1,
					ad: soFar.ad + (A2($elm$core$Basics$pow, 16, soFar.Z) * $stil4m$elm_syntax$Elm$Parser$Tokens$charToHex(c))
				};
			}),
		{Z: 0, ad: 0},
		string).ad;
...
var $stil4m$elm_syntax$ParserFast$ifFollowedByWhileMapWithoutLinebreak = F3(
	function (consumedStringToRes, firstIsOkay, afterFirstIsOkay) {
		return function (s0) {
			var firstOffset = A3($stil4m$elm_syntax$ParserFast$isSubCharWithoutLinebreak, firstIsOkay, s0.d, s0.c);
			if (_Utils_eq(firstOffset, -1)) {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingCharSatisfyingPredicate, s0.aX, s0.at));
			} else {
				var s1 = A6($stil4m$elm_syntax$ParserFast$skipWhileWithoutLinebreakHelp, afterFirstIsOkay, firstOffset, s0.aX, s0.at + 1, s0.c, s0.f);
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					consumedStringToRes(
						A3($elm$core$String$slice, s0.d, s1.d, s0.c)),
	...
	function (firstToChoice, _v0, secondToChoice, _v1) {
		...
		return function (s) {
			...
			if (!_v2.$) {
				...
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					A5(firstToChoice, s.aX, s.at, first, s1.aX, s1.at),
					s1);
			} else {
				...
				if (firstCommitted) {
					...
					if (!_v3.$) {
						...
						return A2(
							$stil4m$elm_syntax$ParserFast$Good,
							A5(secondToChoice, s.aX, s.at, second, s1.aX, s1.at),
							s1);
					} else {
				...
				F5(
					function (startRow, startColumn, _char, endRow, endColumn) {
						return A2(
							rangeAndCharToRes,
							{
								av: {Y: endColumn + 1, aX: endRow},
								am: {Y: startColumn - 1, aX: startRow}
							},
							_char);
					}),
				A2(
	...
	function (toResult, firstIsOkay, afterFirstIsOkay, resultIsOkay) {
		return function (s0) {
			...
			if (_Utils_eq(firstOffset, -1)) {
				...
				var s1 = A6($stil4m$elm_syntax$ParserFast$skipWhileWithoutLinebreakHelp, afterFirstIsOkay, firstOffset, s0.aX, s0.at + 1, s0.c, s0.f);
				var name = A3($elm$core$String$slice, s0.d, s1.d, s0.c);
			...
			function (range, s) {
				return {
					...
					a: A2(
						$stil4m$elm_syntax$Elm$Syntax$Node$Node,
						{
							av: {Y: range.av.Y + 2, aX: range.av.aX},
							am: {Y: range.am.Y - 6, aX: range.am.aX}
						},
...
var $stil4m$elm_syntax$ParserFast$keyword = F2(
	function (kwd, res) {
		...
		return function (s) {
			var newOffset = s.d + kwdLength;
			return (_Utils_eq(
				A3($elm$core$String$slice, s.d, newOffset, s.c),
				kwd + '') && (!A2($stil4m$elm_syntax$ParserFast$isSubCharAlphaNumOrUnderscore, newOffset, s.c))) ? A2(
				$stil4m$elm_syntax$ParserFast$Good,
				res,
				{at: s.at + kwdLength, f: s.f, d: newOffset, aX: s.aX, c: s.c}) : A2(
				$stil4m$elm_syntax$ParserFast$Bad,
				false,
				A3($stil4m$elm_syntax$ParserFast$ExpectingKeyword, s.aX, s.at, kwd));
		};
	});
...
var $stil4m$elm_syntax$ParserFast$keywordFollowedBy = F2(
	function (kwd, _v0) {
		...
		return function (s) {
			...
			return (_Utils_eq(
				A3($elm$core$String$slice, s.d, newOffset, s.c),
				kwd + '') && (!A2($stil4m$elm_syntax$ParserFast$isSubCharAlphaNumOrUnderscore, newOffset, s.c))) ? $stil4m$elm_syntax$ParserFast$pStepCommit(
				parseNext(
					{at: s.at + kwdLength, f: s.f, d: newOffset, aX: s.aX, c: s.c})) : A2(
				$stil4m$elm_syntax$ParserFast$Bad,
				false,
...
var $stil4m$elm_syntax$ParserFast$problem = function (msg) {
	return function (s) {
		return A2(
			$stil4m$elm_syntax$ParserFast$Bad,
			false,
			A3($stil4m$elm_syntax$ParserFast$ExpectingCustom, s.aX, s.at, msg));
	};
};
...
var $stil4m$elm_syntax$ParserFast$followedBySkipWhileWhitespace = function (_v0) {
	...
	return function (s0) {
		...
		if (!_v1.$) {
			var res = _v1.a;
			var s1 = _v1.b;
			var s2 = A5($stil4m$elm_syntax$ParserFast$skipWhileWhitespaceHelp, s1.d, s1.aX, s1.at, s1.c, s1.f);
		...
		F2(
			function (range, content) {
				return A2(
					$stil4m$elm_syntax$Elm$Syntax$Node$Node,
					{
						av: {Y: range.av.Y, aX: range.am.aX},
						am: {Y: range.am.Y - 2, aX: range.am.aX}
					},
					'--' + content);
			})));
...
var $stil4m$elm_syntax$ParserFast$skipWhileWhitespaceFollowedBy = function (_v0) {
	var parseNext = _v0;
	return function (s0) {
		var s1 = A5($stil4m$elm_syntax$ParserFast$skipWhileWhitespaceHelp, s0.d, s0.aX, s0.at, s0.c, s0.f);
...
var $stil4m$elm_syntax$ParserFast$whileWithoutLinebreak = function (isGood) {
	return function (s0) {
		var s1 = A6($stil4m$elm_syntax$ParserFast$skipWhileWithoutLinebreakHelp, isGood, s0.d, s0.aX, s0.at, s0.c, s0.f);
		return A2(
			$stil4m$elm_syntax$ParserFast$Good,
			A3($elm$core$String$slice, s0.d, s1.d, s0.c),
			s1);
		...
		F2(
			function (pResult, _v0) {
				...
				return _Utils_Tuple2(
					A2($stil4m$elm_syntax$Rope$prependTo, pResult.b, commentsSoFar),
...
var $stil4m$elm_syntax$ParserWithComments$manyWithoutReverse = function (p) {
	return A4(
		...
		function (_v1) {
			var commentsSoFar = _v1.a;
			var itemsSoFar = _v1.b;
			return {b: commentsSoFar, a: itemsSoFar};
		});
};
	...
	function (isOkay, problemOnIsNotOkay, _v0) {
		...
		return function (s0) {
			...
			if (!_v1.$) {
				var good = _v1;
				var s1 = good.b;
				return A2(isOkay, s1.at, s1.f) ? good : A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					true,
					A3($stil4m$elm_syntax$ParserFast$ExpectingCustom, s1.aX, s1.at, problemOnIsNotOkay));
			} else {
				var bad = _v1;
				return bad;
			}
			...
			function (before, v, after) {
				return {
					b: A2(
						...
						after,
						A2($stil4m$elm_syntax$Rope$prependTo, v.b, before)),
					a: v.a
				};
			}),
		...
		return function (s) {
			...
			if (_Utils_eq(
				...
				return A2(
					...
					{at: newCol, f: s.f, d: newOffset, aX: s.aX, c: s.c});
			} else {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
	...
	function (offset, src) {
		...
		switch (_v0) {
			...
			case '1':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 1, offset + 1, src)
				};
			case '2':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 2, offset + 1, src)
				};
			case '3':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 3, offset + 1, src)
				};
			case '4':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 4, offset + 1, src)
				};
			case '5':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 5, offset + 1, src)
				};
			case '6':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 6, offset + 1, src)
				};
			case '7':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 7, offset + 1, src)
				};
			case '8':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 8, offset + 1, src)
				};
			case '9':
				return {
					n: 0,
					g: A3($stil4m$elm_syntax$ParserFast$convert0OrMore0To9s, 9, offset + 1, src)
				};
			default:
...
var $stil4m$elm_syntax$ParserFast$integerDecimalOrHexadecimalMapWithRange = F2(
	function (rangeAndIntDecimalToRes, rangeAndIntHexadecimalToRes) {
		return function (s0) {
			var s1 = A2($stil4m$elm_syntax$ParserFast$convertIntegerDecimalOrHexadecimal, s0.d, s0.c);
			if (_Utils_eq(s1.g.d, -1)) {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingNumber, s0.aX, s0.at));
			} else {
				var newColumn = s0.at + (s1.g.d - s0.d);
				var range = {
					av: {Y: newColumn, aX: s0.aX},
					am: {Y: s0.at, aX: s0.aX}
				};
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					function () {
						var _v0 = s1.n;
						if (!_v0) {
							return A2(rangeAndIntDecimalToRes, range, s1.g.aF);
						} else {
							return A2(rangeAndIntHexadecimalToRes, range, s1.g.aF);
						}
					}(),
					{at: newColumn, f: s0.f, d: s1.g.d, aX: s0.aX, c: s0.c});
			}
		};
	});
...
var $stil4m$elm_syntax$ParserFast$ifFollowedByWhileWithoutLinebreak = F2(
	function (firstIsOkay, afterFirstIsOkay) {
		return function (s) {
			var firstOffset = A3($stil4m$elm_syntax$ParserFast$isSubCharWithoutLinebreak, firstIsOkay, s.d, s.c);
			if (_Utils_eq(firstOffset, -1)) {
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingCharSatisfyingPredicate, s.aX, s.at));
			} else {
				var s1 = A6($stil4m$elm_syntax$ParserFast$skipWhileWithoutLinebreakHelp, afterFirstIsOkay, firstOffset, s.aX, s.at + 1, s.c, s.f);
				return A2(
					$stil4m$elm_syntax$ParserFast$Good,
					A3($elm$core$String$slice, s.d, s1.d, s.c),
					s1);
	...
	F3(
		function (range, firstName, after) {
			return A2(
				...
				function () {
					if (after.$ === 1) {
						return {ac: _List_Nil, bu: firstName};
					} else {
						var _v1 = after.a;
						var qualificationAfter = _v1.a;
						var unqualified = _v1.b;
						return {
							ac: A2($elm$core$List$cons, firstName, qualificationAfter),
							bu: unqualified
						};
					}
				}());
...
var $stil4m$elm_syntax$Elm$Parser$Patterns$recordPattern = A3(
	...
	F3(
		function (range, commentsBeforeElements, elements) {
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, elements.b, commentsBeforeElements),
				a: A2(
					$stil4m$elm_syntax$Elm$Syntax$Node$Node,
					range,
	...
	A2(
			...
			A4(
				...
				F3(
					function (head, commentsAfterHead, tail) {
						return {
							b: A2($stil4m$elm_syntax$Rope$prependTo, tail.b, commentsAfterHead),
						...
						A4(
							...
							F3(
								function (beforeName, name, afterName) {
									return {
										b: A2($stil4m$elm_syntax$Rope$prependTo, afterName, beforeName),
										a: name
									};
								}),
							$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
		...
		A2(
			$stil4m$elm_syntax$ParserFast$symbol,
			'}',
			{b: $stil4m$elm_syntax$Rope$empty, a: _List_Nil})));
		...
		F3(
			function (x, commentsAfterLeft, maybeComposedWithResult) {
				return {
					b: A2(
						$stil4m$elm_syntax$Rope$prependTo,
						maybeComposedWithResult.b,
						A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterLeft, x.b)),
					a: function () {
			...
			function (_v4, afterStartName, argsReverse) {
				...
				var range = function () {
					...
					if (!_v5.b) {
						...
						return {av: lastArgRange.av, am: nameRange.am};
					}
				}();
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, argsReverse.b, afterStartName),
					a: A2(
						$stil4m$elm_syntax$Elm$Syntax$Node$Node,
						range,
						A2(
				...
				A3(
					...
					F2(
						function (arg, commentsAfterArg) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterArg, arg.b),
								a: arg.a
							};
						}),
							...
							return $elm$core$Maybe$Just(
								{
									b: A2(
										$stil4m$elm_syntax$Rope$prependTo,
										commentsAfterHead,
										A2($stil4m$elm_syntax$Rope$prependTo, tail.b, head.b)),
			...
			A3(
				...
				F2(
					function (commentsAfterCons, patternResult) {
						return {
							b: A2($stil4m$elm_syntax$Rope$prependTo, patternResult.b, commentsAfterCons),
		...
		A3(
			...
			F3(
				function (range, commentsBeforeHead, contentResult) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, contentResult.b, commentsBeforeHead),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: range.av,
								am: {Y: range.am.Y - 1, aX: range.am.aX}
							},
							contentResult.a)
					};
				}),
			...
			A2(
				...
				A2(
					$stil4m$elm_syntax$ParserFast$symbol,
					')',
					{b: $stil4m$elm_syntax$Rope$empty, a: $stil4m$elm_syntax$Elm$Syntax$Pattern$UnitPattern}),
				A4(
					$stil4m$elm_syntax$ParserFast$map3,
					F3(
						function (headResult, commentsAfterHead, tailResult) {
							return {
								b: A2(
									$stil4m$elm_syntax$Rope$prependTo,
									tailResult.b,
									A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterHead, headResult.b)),
								a: function () {
									...
									if (_v1.$ === 1) {
										...
										var _v2 = secondAndMaybeThirdPart.aI;
										if (_v2.$ === 1) {
											return $stil4m$elm_syntax$Elm$Syntax$Pattern$TuplePattern(
												_List_fromArray(
													[headResult.a, secondAndMaybeThirdPart.ak]));
										} else {
											var thirdPart = _v2.a;
											return $stil4m$elm_syntax$Elm$Syntax$Pattern$TuplePattern(
												_List_fromArray(
													[headResult.a, secondAndMaybeThirdPart.ak, thirdPart]));
										}
									}
								}()
							};
					...
					A2(
						...
						A2(
							$stil4m$elm_syntax$ParserFast$symbol,
							')',
							{b: $stil4m$elm_syntax$Rope$empty, a: $elm$core$Maybe$Nothing}),
						A2(
							$stil4m$elm_syntax$ParserFast$symbolFollowedBy,
							',',
							A5(
										...
										return {
											b: A2(
												...
												A2(
													$stil4m$elm_syntax$Rope$prependTo,
													commentsAfter,
													A2($stil4m$elm_syntax$Rope$prependTo, secondPart.b, commentsBefore))),
											a: $elm$core$Maybe$Just(
												{aI: maybeThirdPart.a, ak: secondPart.a})
										};
									}),
								$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
								$stil4m$elm_syntax$Elm$Parser$Patterns$cyclic$pattern(),
													...
													function (commentsBefore, thirdPart, commentsAfter) {
														return {
															b: A2(
																$stil4m$elm_syntax$Rope$prependTo,
																commentsAfter,
																A2($stil4m$elm_syntax$Rope$prependTo, thirdPart.b, commentsBefore)),
	...
	A3(
		...
		F2(
			function (patternResult, commentsAfterPattern) {
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterPattern, patternResult.b),
					a: patternResult.a
				};
			}),
	...
	function (rangeAndFloatToRes, rangeAndIntDecimalToRes, rangeAndIntHexadecimalToRes) {
		return function (s0) {
			...
			if (_Utils_eq(s1.g.d, -1)) {
				...
				var offsetAfterFloat = A2($stil4m$elm_syntax$ParserFast$skipFloatAfterIntegerDecimal, s1.g.d, s0.c);
				if (_Utils_eq(offsetAfterFloat, -1)) {
					...
					var _v1 = $elm$core$String$toFloat(
						A3($elm$core$String$slice, s0.d, offsetAfterFloat, s0.c));
					if (!_v1.$) {
						var _float = _v1.a;
						var newColumn = s0.at + (offsetAfterFloat - s0.d);
						return A2(
							$stil4m$elm_syntax$ParserFast$Good,
							A2(
								rangeAndFloatToRes,
								...
								_float),
							{at: newColumn, f: s0.f, d: offsetAfterFloat, aX: s0.aX, c: s0.c});
					} else {
						return A2(
							$stil4m$elm_syntax$ParserFast$Bad,
							false,
		...
		return function (s) {
			...
			if (_Utils_eq(firstOffset, -1)) {
				...
				return resultIsOkay(name) ? A2($stil4m$elm_syntax$ParserFast$Good, name, s1) : A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A2($stil4m$elm_syntax$ParserFast$ExpectingStringSatisfyingPredicate, s.aX, s.at + 1));
			}
		};
	});
					...
					if (after.$ === 1) {
						...
						if (!recordAccesses.b) {
							...
							var referenceNode = A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{
									av: {Y: firstRecordAccessRange.am.Y - 1, aX: firstRecordAccessRange.am.aX},
									am: range.am
								},
								A2(
									$stil4m$elm_syntax$Elm$Syntax$Expression$FunctionOrValue,
							...
							return A3(
								...
								F2(
									function (fieldNode, leftNode) {
										...
										return A2(
											$stil4m$elm_syntax$Elm$Syntax$Node$Node,
											{av: fieldRange.av, am: leftRange.am},
	...
	return A4(
		...
		F3(
			function (nameNode, commentsAfterName, argsReverse) {
				...
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, argsReverse.b, commentsAfterName),
					a: A2(
						$stil4m$elm_syntax$Elm$Syntax$Node$Node,
						range,
						A2(
				...
				A3(
					...
					F2(
						function (typeAnnotationResult, commentsAfter) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, typeAnnotationResult.b),
						...
						return {
							b: A2(
								...
								A2(
									...
									A2($stil4m$elm_syntax$Rope$prependTo, firstPart.b, commentsBeforeFirstPart))),
							a: A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{
									av: rangeAfterOpeningParens.av,
									am: {Y: rangeAfterOpeningParens.am.Y - 1, aX: rangeAfterOpeningParens.am.aX}
								},
								function () {
									...
									if (_v5.$ === 1) {
										...
										var _v7 = firstAndMaybeThirdPart.aI;
										if (_v7.$ === 1) {
											return $stil4m$elm_syntax$Elm$Syntax$TypeAnnotation$Tupled(
												_List_fromArray(
													[firstPart.a, firstAndMaybeThirdPart.ak]));
										} else {
											var thirdPart = _v7.a;
											return $stil4m$elm_syntax$Elm$Syntax$TypeAnnotation$Tupled(
												_List_fromArray(
													[firstPart.a, firstAndMaybeThirdPart.ak, thirdPart]));
										}
									}
								}())
						};
								...
								function (commentsBefore, secondPartResult, commentsAfter, maybeThirdPartResult) {
									return {
										b: A2(
											$stil4m$elm_syntax$Rope$prependTo,
											commentsAfter,
											A2($stil4m$elm_syntax$Rope$prependTo, secondPartResult.b, commentsBefore)),
										a: $elm$core$Maybe$Just(
											{aI: maybeThirdPartResult.a, ak: secondPartResult.a})
									};
								}),
							$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
							$stil4m$elm_syntax$Elm$Parser$TypeAnnotation$cyclic$typeAnnotation(),
												...
												function (commentsBefore, thirdPartResult, commentsAfter) {
													return {
														b: A2(
															$stil4m$elm_syntax$Rope$prependTo,
															commentsAfter,
															A2($stil4m$elm_syntax$Rope$prependTo, thirdPartResult.b, commentsBefore)),
	...
	return A3(
		...
		F3(
			function (range, commentsBefore, afterCurly) {
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, afterCurly.b, commentsBefore),
					a: function () {
				...
				A4(
					...
					F3(
						function (firstNameNode, commentsAfterFirstName, afterFirstName) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, afterFirstName.b, commentsAfterFirstName),
								a: $elm$core$Maybe$Just(
									function () {
										...
										if (!_v4.$) {
											...
											return $stil4m$elm_syntax$Elm$Syntax$TypeAnnotation$Record(
												A2(
													$elm$core$List$cons,
													A3($stil4m$elm_syntax$Elm$Syntax$Node$combine, $elm$core$Tuple$pair, firstNameNode, fieldsAfterName.ay),
													fieldsAfterName.a2));
										}
									}())
							};
									...
									function (range, commentsBefore, head, tail) {
										return {
											b: A2(
												$stil4m$elm_syntax$Rope$prependTo,
												tail.b,
												A2($stil4m$elm_syntax$Rope$prependTo, head.b, commentsBefore)),
										...
										A3(
											...
											F2(
												function (commentsBefore, field) {
													return {
														b: A2($stil4m$elm_syntax$Rope$prependTo, field.b, commentsBefore),
														a: field.a
													};
												}),
											$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
										...
										return {
											b: A2(
												...
												A2(
													...
													A2($stil4m$elm_syntax$Rope$prependTo, firstFieldValue.b, commentsBeforeFirstFieldValue))),
											a: $stil4m$elm_syntax$Elm$Parser$TypeAnnotation$FieldsAfterName(
												{ay: firstFieldValue.a, a2: tailFields.a})
										};
									}),
								$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
								$stil4m$elm_syntax$Elm$Parser$TypeAnnotation$cyclic$typeAnnotation(),
			...
			function (inType, commentsAfterIn, maybeOut) {
				return {
					b: A2(
						$stil4m$elm_syntax$Rope$prependTo,
						maybeOut.b,
						A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterIn, inType.b)),
					a: function () {
						var _v0 = maybeOut.a;
						if (_v0.$ === 1) {
							return inType.a;
		...
		A4(
			...
			F2(
				function (commentsAfterArrow, typeAnnotationResult) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, typeAnnotationResult.b, commentsAfterArrow),
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return isOkay(a) ? good : A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					true,
					A3($stil4m$elm_syntax$ParserFast$ExpectingCustom, s1.aX, s1.at, problemOnNotOkay));
			}
		};
	});
		...
		return function (s0) {
			...
			if (_v0.$ === 1) {
				...
				return A2(
					$stil4m$elm_syntax$ParserFast$Bad,
					false,
					A3($stil4m$elm_syntax$ParserFast$ExpectingCustom, s0.aX, s0.at, problemMessage));
			} else {
				...
				return $stil4m$elm_syntax$ParserFast$pStepCommit(
					parseFollowup(
						{at: s1Column, f: s0.f, d: s1Offset, aX: s0.aX, c: s0.c}));
			}
		};
	});
var $stil4m$elm_syntax$ParserFast$changeIndent = F2(
	function (newIndent, s) {
		return {at: s.at, f: newIndent, d: s.d, aX: s.aX, c: s.c};
	});
var $stil4m$elm_syntax$ParserFast$withIndentSetToColumn = function (_v0) {
	var parse = _v0;
	return function (s0) {
		var _v1 = parse(
			A2($stil4m$elm_syntax$ParserFast$changeIndent, s0.at, s0));
		if (!_v1.$) {
			var a = _v1.a;
			var s1 = _v1.b;
			return A2(
				$stil4m$elm_syntax$ParserFast$Good,
				a,
				A2($stil4m$elm_syntax$ParserFast$changeIndent, s0.f, s1));
		} else {
			var bad = _v1;
			return bad;
		}
...
var $stil4m$elm_syntax$ParserFast$withIndentSetToColumnMinus = F2(
	function (columnToMoveIndentationBaseBackBy, _v0) {
		...
		return function (s0) {
			var _v1 = parse(
				A2($stil4m$elm_syntax$ParserFast$changeIndent, s0.at - columnToMoveIndentationBaseBackBy, s0));
			if (!_v1.$) {
				var a = _v1.a;
				var s1 = _v1.b;
				return A2(
		...
		return A4(
			...
			F2(
				function (extensionRightResult, leftNodeWithComments) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, extensionRightResult.b, leftNodeWithComments.b),
			...
			A: A3(
				...
				F2(
					function (commentsBeforeFirst, first) {
						return {
							b: A2($stil4m$elm_syntax$Rope$prependTo, first.b, commentsBeforeFirst),
							a: {bi: 0, u: first.a, G: symbol}
						};
					}),
				$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
				A2(
					...
					function (info) {
						return (_Utils_cmp(info.B, leftPrecedence) > 0) ? $elm$core$Result$Ok(info) : $stil4m$elm_syntax$Elm$Parser$Expression$temporaryErrPrecedenceTooHigh;
					},
					function ($) {
						return $.A;
					})),
			...
			A: A3(
				...
				F2(
					function (commentsBefore, right) {
						return {
							b: A2($stil4m$elm_syntax$Rope$prependTo, right.b, commentsBefore),
							a: {bi: 2, u: right.a, G: symbol}
						};
					}),
				$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
				A2(
					$stil4m$elm_syntax$Elm$Parser$Expression$extendedSubExpressionOptimisticLayout,
					function (info) {
						return (_Utils_cmp(info.B, leftPrecedence) > -1) ? $elm$core$Result$Ok(info) : $stil4m$elm_syntax$Elm$Parser$Expression$temporaryErrPrecedenceTooHigh;
					},
					function (info) {
						return _Utils_eq(info.B, leftPrecedence) ? $stil4m$elm_syntax$Elm$Parser$Expression$problemCannotMixNonAssociativeInfixOperators : info.A;
					})),
			B: leftPrecedence,
			G: symbol
		};
				...
				function (start, declarations, commentsAfterIn, expressionResult) {
					...
					return {
						b: A2(
							$stil4m$elm_syntax$Rope$prependTo,
							expressionResult.b,
							A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterIn, declarations.b)),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: expressionRange.av,
								am: {Y: start.Y - 3, aX: start.aX}
							},
							$stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
								{bh: declarations.bh, u: expressionResult.a}))
					};
				}),
			A2(
				...
				A3(
					...
					F2(
						function (commentsAfterLet, declarations) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, declarations.b, commentsAfterLet),
								bh: declarations.a
							};
						}),
					$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
				...
				function (headLetResult, commentsAfter, tailLetResult) {
					return {
						b: A2(
							$stil4m$elm_syntax$Rope$prependTo,
							tailLetResult.b,
							A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, headLetResult.b)),
		...
		A3(
			...
			F2(
				function (letDeclarationResult, commentsAfter) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, letDeclarationResult.b),
						...
						b: A2(
							...
							A2(
								...
								A2(
									$stil4m$elm_syntax$Rope$prependTo,
									commentsBeforeOf,
									A2($stil4m$elm_syntax$Rope$prependTo, casedExpressionResult.b, commentsAfterCase)))),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: function () {
									if (lastToSecondCase.b) {
										...
										return lastCaseExpressionRange.av;
									} else {
										var _v36 = firstCase;
										var _v37 = _v36.b;
										var firstCaseExpressionRange = _v37.a;
										return firstCaseExpressionRange.av;
									}
								}(),
								am: {Y: start.Y - 4, aX: start.aX}
							},
					...
					b: A2(
						...
						A2(
							...
							A2(
								...
								A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterFirstCasePattern, firstCasePatternResult.b)))),
					a: _Utils_Tuple2(
					...
					return {
						b: A2(
							...
							A2(
								...
								A2($stil4m$elm_syntax$Rope$prependTo, commentsBeforeArrowRight, pattern.b))),
							...
							return {
								b: A2(
									...
									A2(
										$stil4m$elm_syntax$Rope$prependTo,
										commentsAfter,
										A2($stil4m$elm_syntax$Rope$prependTo, partResult.b, commentsBefore))),
					...
					return {
						b: A2(
							...
							A2(
								$stil4m$elm_syntax$Rope$prependTo,
								tailFields.b,
								A2($stil4m$elm_syntax$Rope$prependTo, afterNameBeforeFields.b, commentsAfterFunctionName))),
						a: function () {
					...
					A3(
						...
						F2(
							function (commentsBefore, setterResult) {
								return {
									b: A2($stil4m$elm_syntax$Rope$prependTo, setterResult.b, commentsBefore),
							...
							function (commentsBefore, expressionResult, commentsAfter) {
								return {
									b: A2(
										$stil4m$elm_syntax$Rope$prependTo,
										commentsAfter,
										A2($stil4m$elm_syntax$Rope$prependTo, expressionResult.b, commentsBefore)),
	...
	return A3(
		...
		function (result) {
			...
			if (letDeclaration.$ === 1) {
				...
				var _v20 = letFunctionDeclaration.F;
				if (_v20.$ === 1) {
					return true;
				} else {
					var _v21 = _v20.a;
					var signature = _v21.b;
					var _v22 = signature.bu;
					var signatureName = _v22.b;
					var _v23 = letFunctionDeclaration.bg;
					var implementation = _v23.b;
					var _v24 = implementation.bu;
							...
							A2(
								...
								function () {
									if (maybeSignature.$ === 1) {
										...
										return A2($stil4m$elm_syntax$Rope$prependTo, signature.b, commentsAfterStartName);
									}
								}())));
					if (maybeSignature.$ === 1) {
						...
						return {
							...
							a: A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{av: expressionRange.av, am: startNameStart},
								$stil4m$elm_syntax$Elm$Syntax$Expression$LetFunction(
									{
										bg: A2(
											$stil4m$elm_syntax$Elm$Syntax$Node$Node,
											{av: expressionRange.av, am: startNameStart},
											{y: _arguments.a, u: expressionResult.a, bu: startNameNode}),
								...
								$stil4m$elm_syntax$Elm$Syntax$Expression$LetFunction(
									{
										bg: A2(
											$stil4m$elm_syntax$Elm$Syntax$Node$Node,
											{av: expressionRange.av, am: implementationNameRange.am},
											{y: _arguments.a, u: expressionResult.a, bu: signature.O}),
										z: $elm$core$Maybe$Nothing,
										F: $elm$core$Maybe$Just(
											A3($stil4m$elm_syntax$Elm$Syntax$Node$combine, $stil4m$elm_syntax$Elm$Syntax$Signature$Signature, startNameNode, signature.l))
									}))
						};
					}
				}),
						...
						return $elm$core$Maybe$Just(
							{
								b: A2(
									...
									A2(
										...
										A2($stil4m$elm_syntax$Rope$prependTo, typeAnnotationResult.b, commentsBeforeTypeAnnotation))),
								O: implementationName.a,
								l: typeAnnotationResult.a
							});
					}),
				A2($stil4m$elm_syntax$ParserFast$symbolFollowedBy, ':', $stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout),
				...
				return {
					b: A2(
						...
						A2(
							$stil4m$elm_syntax$Rope$prependTo,
							commentsAfterEquals,
							A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterPattern, pattern.b))),
					a: A2(
						$stil4m$elm_syntax$Elm$Syntax$Node$Node,
						{av: end, am: start},
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2($stil4m$elm_syntax$Rope$prependTo, firstArg.b, commentsAfterBackslash))))),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: expressionRange.av,
								am: {Y: start.Y - 1, aX: start.aX}
							},
							$stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
								{
									x: A2($elm$core$List$cons, firstArg.a, secondUpArgs.a),
				...
				A3(
					...
					F2(
						function (patternResult, commentsAfter) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, patternResult.b),
								a: patternResult.a
							};
						}),
					$stil4m$elm_syntax$Elm$Parser$Patterns$patternNotDirectlyComposing,
									...
									A2(
										...
										A2(
											...
											A2(
												$stil4m$elm_syntax$Rope$prependTo,
												commentsBeforeThen,
												A2($stil4m$elm_syntax$Rope$prependTo, condition.b, commentsAfterIf))))))),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: ifFalseRange.av,
								am: {Y: start.Y - 2, aX: start.aX}
							},
		...
		A3(
			...
			F3(
				function (range, commentsBefore, elements) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, elements.b, commentsBefore),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{
								av: range.av,
							...
							function (head, commentsAfterHead, tail) {
								return {
									b: A2(
										$stil4m$elm_syntax$Rope$prependTo,
										tail.b,
										A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterHead, head.b)),
		...
		function (subExpressionResult) {
			...
			return {
				...
				a: A2(
					$stil4m$elm_syntax$Elm$Syntax$Node$Node,
					{
						av: subExpressionRange.av,
						am: {Y: subExpressionRange.am.Y - 1, aX: subExpressionRange.am.aX}
					},
			...
			function (leftExpressionResult, commentsBeforeExtension, maybeArgsReverse) {
				return {
					b: A2(
						$stil4m$elm_syntax$Rope$prependTo,
						maybeArgsReverse.b,
						A2($stil4m$elm_syntax$Rope$prependTo, commentsBeforeExtension, leftExpressionResult.b)),
					a: function () {
						...
						if (!_v0.b) {
							...
							return A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{av: lastArgRange.av, am: leftRange.am},
			...
			A3(
				...
				F2(
					function (arg, commentsAfter) {
						return {
							b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, arg.b),
							a: arg.a
						};
					}),
				$stil4m$elm_syntax$Elm$Parser$Layout$positivelyIndentedFollowedBy(
				...
				return $elm$core$Maybe$Just(
					{
						b: A2(
							...
							A2(
								...
								implementationName.b,
								A2($stil4m$elm_syntax$Rope$prependTo, typeAnnotationResult.b, commentsBeforeTypeAnnotation))),
						a: {O: implementationName.a, l: typeAnnotationResult.a}
					});
			}),
		A2($stil4m$elm_syntax$ParserFast$symbolFollowedBy, ':', $stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout),
		$stil4m$elm_syntax$Elm$Parser$TypeAnnotation$typeAnnotation,
...
var $stil4m$elm_syntax$Elm$Parser$Layout$layoutStrictFollowedByWithComments = function (nextParser) {
	return A3(
		...
		F2(
			function (commentsBefore, after) {
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, after.b, commentsBefore),
					a: after.a
				};
			}),
		$stil4m$elm_syntax$Elm$Parser$Layout$optimisticLayout,
...
var $stil4m$elm_syntax$Elm$Parser$Declarations$valueConstructorOptimisticLayout = A4(
	...
	F3(
		function (name, commentsAfterName, argumentsReverse) {
			...
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, argumentsReverse.b, commentsAfterName),
				a: A2(
					$stil4m$elm_syntax$Elm$Syntax$Node$Node,
					fullRange,
					{
						y: $elm$core$List$reverse(argumentsReverse.a),
						bu: name
					})
			};
		}),
				...
				b: A2(
					...
					A2(
						...
						A2(
							$stil4m$elm_syntax$Rope$prependTo,
							commentsAfterEqual,
							A2($stil4m$elm_syntax$Rope$prependTo, parameters.b, commentsAfterName)))),
				a: $stil4m$elm_syntax$Elm$Parser$Declarations$TypeDeclarationAfterDocumentation(
					{N: headVariant.a, bu: name, D: parameters.a, Q: tailVariantsReverse.a})
			};
		}),
	$stil4m$elm_syntax$Elm$Parser$Tokens$typeNameNode,
	$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
				...
				A3(
					...
					F2(
						function (commentsBeforePipe, variantResult) {
							return {
								b: A2($stil4m$elm_syntax$Rope$prependTo, variantResult.b, commentsBeforePipe),
								a: variantResult.a
							};
						}),
					$stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout,
		...
		function (commentsAfterAlias, name, commentsAfterName, parameters, commentsAfterEquals, typeAnnotationResult) {
			return {
				...
				a: $stil4m$elm_syntax$Elm$Parser$Declarations$TypeAliasDeclarationAfterDocumentation(
					{bu: name, D: parameters.a, l: typeAnnotationResult.a})
			};
		}),
...
var $stil4m$elm_syntax$Elm$Parser$Declarations$typeOrTypeAliasDefinitionAfterDocumentation = A3(
	...
	F2(
		function (commentsAfterType, declarationAfterDocumentation) {
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, declarationAfterDocumentation.b, commentsAfterType),
...
var $stil4m$elm_syntax$Elm$Parser$Declarations$declarationWithDocumentation = A3(
	...
	function (result) {
		...
		if (!decl.$) {
			...
			var _v13 = letFunctionDeclaration.F;
			if (_v13.$ === 1) {
				return true;
			} else {
				var _v14 = _v13.a;
				var signature = _v14.b;
				var _v15 = signature.bu;
				var signatureName = _v15.b;
				var _v16 = letFunctionDeclaration.bg;
				var implementation = _v16.b;
				var _v17 = implementation.bu;
	...
	A3(
		...
		F2(
			function (documentation, afterDocumentation) {
				var start = $stil4m$elm_syntax$Elm$Syntax$Node$range(documentation).am;
				var _v0 = afterDocumentation.a;
				switch (_v0.$) {
					case 0:
						var functionDeclarationAfterDocumentation = _v0.a;
						var _v1 = functionDeclarationAfterDocumentation.F;
						if (!_v1.$) {
							var signature = _v1.a;
							var _v2 = signature.O;
							...
							return {
								...
								a: A2(
									$stil4m$elm_syntax$Elm$Syntax$Node$Node,
									{av: expressionRange.av, am: start},
									$stil4m$elm_syntax$Elm$Syntax$Declaration$FunctionDeclaration(
										{
											bg: A2(
												$stil4m$elm_syntax$Elm$Syntax$Node$Node,
												{av: expressionRange.av, am: implementationNameRange.am},
												{y: functionDeclarationAfterDocumentation.y, u: functionDeclarationAfterDocumentation.u, bu: signature.O}),
											z: $elm$core$Maybe$Just(documentation),
											F: $elm$core$Maybe$Just(
												A3($stil4m$elm_syntax$Elm$Syntax$Node$combine, $stil4m$elm_syntax$Elm$Syntax$Signature$Signature, functionDeclarationAfterDocumentation.ae, signature.l))
										}))
							};
						} else {
							var _v4 = functionDeclarationAfterDocumentation.ae;
									...
									$stil4m$elm_syntax$Elm$Syntax$Declaration$FunctionDeclaration(
										{
											bg: A2(
												$stil4m$elm_syntax$Elm$Syntax$Node$Node,
												{av: expressionRange.av, am: startNameRange.am},
												{y: functionDeclarationAfterDocumentation.y, u: functionDeclarationAfterDocumentation.u, bu: functionDeclarationAfterDocumentation.ae}),
											z: $elm$core$Maybe$Just(documentation),
											F: $elm$core$Maybe$Nothing
										}))
							};
					...
					case 1:
						...
						var end = function () {
							var _v6 = typeDeclarationAfterDocumentation.Q;
							if (_v6.b) {
								var _v7 = _v6.a;
								var range = _v7.a;
								return range.av;
							} else {
								var _v8 = typeDeclarationAfterDocumentation.N;
								var headVariantRange = _v8.a;
								return headVariantRange.av;
							}
						}();
						return {
							b: afterDocumentation.b,
								...
								$stil4m$elm_syntax$Elm$Syntax$Declaration$CustomTypeDeclaration(
									{
										be: A2(
											$elm$core$List$cons,
											typeDeclarationAfterDocumentation.N,
											$elm$core$List$reverse(typeDeclarationAfterDocumentation.Q)),
										z: $elm$core$Maybe$Just(documentation),
										aa: typeDeclarationAfterDocumentation.D,
										bu: typeDeclarationAfterDocumentation.bu
									}))
						};
					case 2:
						var typeAliasDeclarationAfterDocumentation = _v0.a;
						var _v9 = typeAliasDeclarationAfterDocumentation.l;
						var typeAnnotationRange = _v9.a;
						return {
							b: afterDocumentation.b,
							a: A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{av: typeAnnotationRange.av, am: start},
								$stil4m$elm_syntax$Elm$Syntax$Declaration$AliasDeclaration(
									{
										z: $elm$core$Maybe$Just(documentation),
										aa: typeAliasDeclarationAfterDocumentation.D,
										bu: typeAliasDeclarationAfterDocumentation.bu,
										l: typeAliasDeclarationAfterDocumentation.l
									}))
						};
					default:
						var portDeclarationAfterName = _v0.a;
						var _v10 = portDeclarationAfterName.l;
						...
						return {
							...
							a: A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								{av: typeAnnotationRange.av, am: portDeclarationAfterName.a$},
								$stil4m$elm_syntax$Elm$Syntax$Declaration$PortDeclaration(
									{bu: portDeclarationAfterName.bu, l: portDeclarationAfterName.l}))
						};
				}
			}),
...
var $stil4m$elm_syntax$Elm$Parser$Declarations$functionDeclarationWithoutDocumentation = A3(
	...
	function (result) {
		...
		if (!decl.$) {
			var letFunctionDeclaration = decl.a;
			var _v7 = letFunctionDeclaration.F;
			if (_v7.$ === 1) {
				return true;
			} else {
				var _v8 = _v7.a;
				var signature = _v8.b;
				var _v9 = signature.bu;
				var signatureName = _v9.b;
				var _v10 = letFunctionDeclaration.bg;
				var implementation = _v10.b;
				var _v11 = implementation.bu;
							...
							$stil4m$elm_syntax$Elm$Syntax$Declaration$FunctionDeclaration(
								{
									bg: A2(
										$stil4m$elm_syntax$Elm$Syntax$Node$Node,
										{av: expressionRange.av, am: startNameStart},
										{y: _arguments.a, u: result.a, bu: startNameNode}),
									z: $elm$core$Maybe$Nothing,
									F: $elm$core$Maybe$Nothing
								}))
					};
							...
							$stil4m$elm_syntax$Elm$Syntax$Declaration$FunctionDeclaration(
								{
									bg: A2(
										$stil4m$elm_syntax$Elm$Syntax$Node$Node,
										{av: expressionRange.av, am: implementationNameRange.am},
										{y: _arguments.a, u: result.a, bu: signature.O}),
									z: $elm$core$Maybe$Nothing,
									F: $elm$core$Maybe$Just(
										A3($stil4m$elm_syntax$Elm$Syntax$Node$combine, $stil4m$elm_syntax$Elm$Syntax$Signature$Signature, startNameNode, signature.l))
								}))
...
var $stil4m$elm_syntax$ParserFast$errorAsOffsetAndInt = {aF: 0, d: -1};
var $stil4m$elm_syntax$ParserFast$convertIntegerDecimal = F2(
	function (offset, src) {
		var _v0 = A3($elm$core$String$slice, offset, offset + 1, src);
		switch (_v0) {
			case '0':
				return {aF: 0, d: offset + 1};
			case '1':
...
var $stil4m$elm_syntax$ParserFast$integerDecimalMapWithRange = function (rangeAndIntToRes) {
	return function (s0) {
		var s1 = A2($stil4m$elm_syntax$ParserFast$convertIntegerDecimal, s0.d, s0.c);
		if (_Utils_eq(s1.d, -1)) {
			return A2(
				$stil4m$elm_syntax$ParserFast$Bad,
				false,
			...
			return A2(
				...
				A2(
					...
					s1.aF),
				{at: newColumn, f: s0.f, d: s1.d, aX: s0.aX, c: s0.c});
		}
	};
};
											...
											return {
												...
												a: A2(
													...
													$stil4m$elm_syntax$Elm$Syntax$Declaration$InfixDeclaration(
														{bi: direction, bm: fn, aL: operator, by: precedence}))
											};
										};
									};
								};
		...
		function (commentsAfterPort, name, commentsAfterName, commentsAfterColon, typeAnnotationResult) {
			...
			return {
				...
				a: A2(
					...
					{
						av: end,
						am: {Y: 1, aX: nameRange.am.aX}
					},
					$stil4m$elm_syntax$Elm$Syntax$Declaration$PortDeclaration(
						{bu: name, l: typeAnnotationResult.a}))
			};
		}),
	A2($stil4m$elm_syntax$ParserFast$keywordFollowedBy, 'port', $stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout),
	$stil4m$elm_syntax$Elm$Parser$Tokens$functionNameNode,
...
var $stil4m$elm_syntax$Elm$Parser$Declarations$typeOrTypeAliasDefinitionWithoutDocumentation = A3(
	...
	F3(
		function (start, commentsAfterType, afterStart) {
			var allComments = A2($stil4m$elm_syntax$Rope$prependTo, afterStart.b, commentsAfterType);
			var _v0 = afterStart.a;
			if (!_v0.$) {
				var typeDeclarationAfterDocumentation = _v0.a;
				var end = function () {
					var _v1 = typeDeclarationAfterDocumentation.Q;
					if (_v1.b) {
						var _v2 = _v1.a;
						var range = _v2.a;
						return range.av;
					} else {
						var _v3 = typeDeclarationAfterDocumentation.N;
				...
				var typeAliasDeclarationAfterDocumentation = _v0.a;
				var _v4 = typeAliasDeclarationAfterDocumentation.l;
				...
				return {
					...
					a: A2(
						...
						{av: typeAnnotationRange.av, am: start},
						$stil4m$elm_syntax$Elm$Syntax$Declaration$AliasDeclaration(
							{z: $elm$core$Maybe$Nothing, aa: typeAliasDeclarationAfterDocumentation.D, bu: typeAliasDeclarationAfterDocumentation.bu, l: typeAliasDeclarationAfterDocumentation.l}))
				};
			}
		}),
	A2($stil4m$elm_syntax$ParserFast$keywordFollowedBy, 'type', $stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout),
		...
		A3(
			...
			F2(
				function (declarationParsed, commentsAfter) {
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, declarationParsed.b),
...
var $stil4m$elm_syntax$Elm$Parser$Expose$typeExpose = A4(
	...
	F3(
		function (_v0, commentsBeforeMaybeOpen, maybeOpen) {
			...
			var typeName = _v0.b;
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, maybeOpen.b, commentsBeforeMaybeOpen),
				a: function () {
					var _v1 = maybeOpen.a;
					if (_v1.$ === 1) {
						return A2(
						...
						return A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{av: openRange.av, am: typeNameRange.am},
							$stil4m$elm_syntax$Elm$Syntax$Exposing$TypeExpose(
								{bu: typeName, bx: maybeOpen.a}));
					}
				}()
			};
		}),
	...
	A4(
		...
		F3(
			function (range, left, right) {
				return {
					b: A2($stil4m$elm_syntax$Rope$prependTo, right, left),
			...
			function (headElement, commentsAfterHeadElement, tailElements) {
				return {
					b: A2(
						$stil4m$elm_syntax$Rope$prependTo,
						tailElements.b,
						A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterHeadElement, headElement.b)),
		...
		function (start, commentsAfterImport, mod, commentsAfterModuleName, maybeModuleAlias, maybeExposingList) {
			...
			if (maybeModuleAlias.$ === 1) {
				if (maybeExposingList.$ === 1) {
					...
					var modRange = _v2.a;
					return {
						b: commentsBeforeAlias,
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{av: modRange.av, am: start},
							{_: $elm$core$Maybe$Nothing, ab: $elm$core$Maybe$Nothing, ac: mod})
					};
				} else {
					...
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, exposingListValue.b, commentsBeforeAlias),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{av: exposingRange.av, am: start},
							{
								_: $elm$core$Maybe$Just(exposingListValue.a),
				...
				if (maybeExposingList.$ === 1) {
					...
					return {
						b: A2($stil4m$elm_syntax$Rope$prependTo, moduleAliasResult.b, commentsBeforeAlias),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{av: aliasRange.av, am: start},
							{
								_: $elm$core$Maybe$Nothing,
								ab: $elm$core$Maybe$Just(moduleAliasResult.a),
								ac: mod
							})
					};
				} else {
					...
					return {
						b: A2(
							$stil4m$elm_syntax$Rope$prependTo,
							exposingListValue.b,
							A2($stil4m$elm_syntax$Rope$prependTo, moduleAliasResult.b, commentsBeforeAlias)),
						a: A2(
							$stil4m$elm_syntax$Elm$Syntax$Node$Node,
							{av: exposingRange.av, am: start},
							{
	...
	A5(
		...
		F3(
			function (commentsBefore, moduleAliasNode, commentsAfter) {
				return $elm$core$Maybe$Just(
					{
						b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, commentsBefore),
						a: moduleAliasNode
					});
			}),
	...
	A4(
		...
		F2(
			function (exposingResult, commentsAfter) {
				return $elm$core$Maybe$Just(
					{
						b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfter, exposingResult.b),
						a: exposingResult.a
					});
			}),
...
var $stil4m$elm_syntax$Elm$Parser$Modules$effectWhereClause = A5(
	...
	F4(
		function (fnName, commentsAfterFnName, commentsAfterEqual, typeName_) {
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, commentsAfterEqual, commentsAfterFnName),
					...
					return {
						b: A2(
							...
							A2(
								$stil4m$elm_syntax$Rope$prependTo,
								commentsAfterHead,
								A2($stil4m$elm_syntax$Rope$prependTo, head.b, commentsBeforeHead))),
						a: {
							af: A2(
								$elm$core$Maybe$map,
...
var $stil4m$elm_syntax$Elm$Parser$Modules$effectWhereClauses = A3(
	...
	F2(
		function (commentsBefore, whereResult) {
			return {
				b: A2($stil4m$elm_syntax$Rope$prependTo, whereResult.b, commentsBefore),
				a: whereResult.a
			};
		}),
			...
			return {
				...
				a: A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
						{af: whereClauses.a.af, _: exp.a, ac: name, ao: whereClauses.a.ao}))
			};
		}),
			...
			return {
				...
				a: A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Module$NormalModule(
						{_: exposingList.a, ac: moduleName}))
			};
		}),
	A2($stil4m$elm_syntax$ParserFast$keywordFollowedBy, 'module', $stil4m$elm_syntax$Elm$Parser$Layout$maybeLayout),
	$stil4m$elm_syntax$Elm$Parser$Base$moduleName,
...
var $stil4m$elm_syntax$Elm$Parser$File$file = A5(
	...
	F4(
		function (moduleDefinition, moduleComments, imports, declarations) {
			return {
				b: $stil4m$elm_syntax$Rope$toList(
					A2(
						$stil4m$elm_syntax$Rope$prependTo,
						declarations.b,
						A2(
							$stil4m$elm_syntax$Rope$prependTo,
							imports.b,
							A2($stil4m$elm_syntax$Rope$prependTo, moduleComments, moduleDefinition.b)))),
				bh: declarations.a,
				bp: imports.a,
				bt: moduleDefinition.a
			};
		}),
	...
	function (problemToConvert, soFar) {
		switch (problemToConvert.$) {
			...
			case 0:
				...
				return A2(
					$elm$core$List$cons,
					{at: col, aP: $elm$parser$Parser$ExpectingNumber, aX: row},
					soFar);
			case 1:
				var row = problemToConvert.a;
				var col = problemToConvert.b;
				...
				return A2(
					...
					{
						at: col,
						aP: $elm$parser$Parser$ExpectingSymbol(symbolString),
						aX: row
					},
					soFar);
			case 2:
				...
				return A2(
					...
					{
						at: col,
						aP: $elm$parser$Parser$Problem('expecting any char'),
						aX: row
					},
					soFar);
			case 3:
				...
				return A2(
					...
					{
						at: col,
						aP: $elm$parser$Parser$ExpectingKeyword(keywordString),
						aX: row
					},
					soFar);
			case 4:
				...
				return A2(
					$elm$core$List$cons,
					{at: col, aP: $elm$parser$Parser$UnexpectedChar, aX: row},
					soFar);
			case 5:
				var row = problemToConvert.a;
				var col = problemToConvert.b;
				return A2(
					...
					{
						at: col,
						aP: $elm$parser$Parser$Problem('expected string to pass validation'),
						aX: row
					},
					soFar);
			default:
				...
				return A2(
					...
					{
						at: col,
						aP: $elm$parser$Parser$Problem(customMessage),
						aX: row
					},
					soFar);
		}
...
var $stil4m$elm_syntax$ParserFast$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{at: 1, f: 1, d: 0, aX: 1, c: src});
		if (!_v1.$) {
			var value = _v1.a;
			var finalState = _v1.b;
			return (!(finalState.d - $elm$core$String$length(finalState.c))) ? $elm$core$Result$Ok(value) : $elm$core$Result$Err(
				_List_fromArray(
					[
						{at: finalState.at, aP: $elm$parser$Parser$ExpectingEnd, aX: finalState.aX}
					]));
		} else {
			var deadEnds = _v1.b;
...
var $author$project$Worker$update = F2(
	function (msg, model) {
		var rawElmSource = msg;
		return _Utils_Tuple2(
			model,
			function () {
				var _v1 = $stil4m$elm_syntax$Elm$Parser$parse(rawElmSource);
				if (!_v1.$) {
					var rawFile = _v1.a;
					return $author$project$Worker$onSuccess(
						$stil4m$elm_syntax$Elm$RawFile$encode(rawFile));
				} else {
					var deadEnds = _v1.a;
					return $author$project$Worker$onFailure('Could not parse Elm file');
				}
			}());
	});
...
var $author$project$Worker$main = $elm$core$Platform$worker(
	{
		...
		bA: $author$project$Worker$subscriptions,
		bC: $author$project$Worker$update
	});
